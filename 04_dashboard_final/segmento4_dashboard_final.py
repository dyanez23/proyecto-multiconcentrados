...
def cargar_pickle_seguro(ruta, descripcion="archivo"):
    ...
    try:
        ...
        print(f"  ⚠️ Error en {descripcion}: {str(e)[:50]}...")
        return None
        ...
        try:
            ...
            fig = make_subplots(
                ...
                subplot_titles=('💰 Ventas Totales', '👥 Clientes Únicos', '📦 Productos',
                              '🎫 Ticket Promedio', '🏷️ Categorías', '🌍 Municipios'),
            ...
            fig.add_trace(go.Indicator(
                ...
                title={"text": "<b>🏷️ Categorías</b><br><span style='font-size:0.8em; color:gray'>Líneas de producto</span>"},
            ...
            fig.update_layout(
                height=500,
                title={
                    'text': "<b>📊 Resumen Ejecutivo de Ventas</b>",
                    'x': 0.5,
            ...
            if not self.data.mlflow_info:
                return html.Div([
                    ...
                    html.Div([
                        ...
                        html.P("⚠️ MLflow no configurado"),
    ...
    dcc.Tabs([
        ...
        dcc.Tab(label='🎯 Clasificación', children=[
            html.Div([
                ...
                tabla_clasificacion,
                html.Hr(),
                html.H3("⚙️ Análisis Interactivo", style={'margin': '40px 0 20px 0'}),
                html.Div([
        ...
        # PESTAÑA 5: INFO
        dcc.Tab(label='ℹ️ Info', children=[
            html.Div([
                ...
                html.Div([
                    html.H3("📋 Estado"),
                    html.Ul([
                        html.Li(f"📁 Segmento 1: {'✅' if not data_loader.usando_datos_demo else '⚠️ Demo'}"),
                        html.Li(f"🤖 Segmento 2: {'✅' if data_loader.resultados_modelos and not data_loader.usando_datos_demo else '⚠️ Demo'}"),
                        html.Li(f"📊 Segmento 3: {'✅' if data_loader.mlflow_info else '⚠️ No disponible'}"),
                    ...
                    html.Ul([
                        ...
                        html.Li("🎛️ Controles interactivos"),
                        html.Li("🔄 Manejo de errores"),
                        html.Li("🎭 Modo demostración")
                    ]),
                    html.Hr(),
                    html.H3("🛠️ Tecnologías"),
                    html.Div([
...
def actualizar_analisis_frecuencia(frecuencia_minima):
    ...
    try:
        ...
        return html.Div([
            html.H4("⚠️ Error", style={'color': 'orange'}),
...
ESTADO:
Segmento 1: {'✅' if not data_loader.usando_datos_demo else '⚠️ DEMO'}
Segmento 2: {'✅' if data_loader.resultados_modelos and not data_loader.usando_datos_demo else '⚠️ DEMO'}
Segmento 3: {'✅' if data_loader.mlflow_info else '⚠️ NO DISPONIBLE'}
